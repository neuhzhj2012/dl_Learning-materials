...
> ---
> 
>   单个样本的交叉熵计算[示例](https://zybuluo.com/hanbingtao/note/541458)。y<sub>i</sub>=[1, 0, 0, 0]， y<sup>^</sup><sub>i</sub>=[0.03, 0.09,0.24,0.64]，则计算结果为
> 
> $$
> -y_{i}\cdot log(\hat{y}_{i})\newline
> =-(1\ast log0.03 + 0\ast log0.09+0\ast log0.24 + 0\ast log0.64)\newline
> =3.51
> $$
> 
> ---
